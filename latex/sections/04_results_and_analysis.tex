...
\begin{figure}[ht]
  ...
  \caption{Global and local accessibility under normal and flood conditions.}
\end{figure}
...
Figure 6. Proposed emergency route network under flood conditions.
