...
\begin{figure}[ht]
  ...
  \caption{Priority corridors and city-wide intervention areas under flood conditions.}
\end{figure}
...
\begin{figure}[ht]
  ...
  \caption{Distribution of emergency boats and safe zones under flood conditions. The figure shows the location of deployed emergency boats in relation to flood-adjusted accessibility (r800), highlighting spatial disparities in coverage across safe and vulnerable zones.}
\end{figure}
