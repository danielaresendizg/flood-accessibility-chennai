...
\begin{scope}[xshift=7.8cm]
  ...
  % Stage 4
  \node[stageLabel] (s4lbl) at (0, -0.3) {stage 4};
  \node[bar] (s4bar) at (1.9, -0.75) {local-scale resilience strategies};
...
\draw[line width=0.7pt] (3.4, 3.1) -- (3.4, -3.3);
\draw[line width=0.7pt] (3.4, 3.1) .. controls (3.8, 3.1) and (3.9, 3.1) .. (4.2, 3.1);
\draw[line width=0.7pt] (3.4, -3.3) .. controls (3.8, -3.3) and (3.9, -3.3) .. (4.2, -3.3);
